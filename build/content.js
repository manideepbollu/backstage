...
/***/ function(module, exports, __webpack_require__) {
	...
	var proxyStore = new _reactChromeRedux.Store({ portName: 'bs-port' });
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _reactShadow = __webpack_require__(238);
	    ...
	    value: function render() {
	      ...
	      if (this.props.icon !== undefined && this.props.icon.clicked) {
	        popup = _react2.default.createElement(
	          ...
	          { include: [chrome.extension.getURL('assets/css/popup.css')] },
	...
	var Header = function (_Component) {
	  ...
	  _createClass(Header, [{
	    ...
	    value: function render() {
	      return _react2.default.createElement(
	        'nav',
	        { id: 'popup-header', className: 'navbar navbar-default' },
	        _react2.default.createElement(
	          'a',
	          { id: 'popup-brand', href: '#' },
	          _react2.default.createElement(
